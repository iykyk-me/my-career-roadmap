...
export default function Sidebar() {
    ...
    return (
        <div className="hidden lg:flex lg:flex-col lg:w-64 lg:h-full lg:border-r lg:bg-white dark:lg:bg-slate-900 lg:border-slate-200 dark:lg:border-slate-800 flex-shrink-0">
            {/* Header */}
